...
let dummyData = [Quote(quote: "The apple does not fall far from the tree.", author: "Ralph Waldo Emerson", index: 1),
                Quote(quote: "Not everything that can be faced can be changed, but be sure that nothing can change until it is faced", author: "Unknown", index: 2),
                 Quote(quote: "Actions are but by intentions", author: "Muhammad", index: 3)
    ]
